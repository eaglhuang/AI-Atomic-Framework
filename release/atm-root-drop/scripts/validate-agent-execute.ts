...
async function importFromTypeScript(relativePath: any) {
...
function assertProtectedFilesStayNeutral() {
  const protectedFiles = [
    ...
    'scripts/validate-agent-execute.ts',
...
try {
  ...
  fixture.expectedValidationPasses.forEach((expectedPass: any, index: any) => {
  ...
  fixture.expectedValidationPasses.forEach((expectedPass: any) => {
