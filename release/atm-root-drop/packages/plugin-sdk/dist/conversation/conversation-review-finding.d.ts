...
export declare const conversationReviewFindingKinds: readonly ["style-format-correction", "workflow-adjustment", "non-trivial-debug-path", "stale-or-wrong-skill"];
export type ConversationReviewFindingKind = typeof conversationReviewFindingKinds[number];
export type ConversationReviewRecommendedTarget = 'host-local-overlay' | 'skill-patch-draft' | 'atom-patch-draft' | 'atom-map-patch-draft' | 'observation-only';
export type ConversationReviewRecommendation = 'draft-host-local-preference' | 'draft-skill-patch' | 'draft-atom-patch' | 'draft-atom-map-patch' | 'observation-only';
export type ConversationReviewPatchDraftKind = 'host-local-overlay' | 'skill-patch' | 'atom-patch' | 'atom-map-patch' | 'observation';
