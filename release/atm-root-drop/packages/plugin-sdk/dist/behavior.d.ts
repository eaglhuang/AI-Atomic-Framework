 ...
 */
export declare const EVOLVE_DELEGATION_TARGET: "ATM-2-0020:ProposeAtomicUpgrade";
...
export interface AtomBehavior {
    ...
    execute(context: AtomBehaviorContext, input: AtomBehaviorInput): Promise<AtomBehaviorOutput> | AtomBehaviorOutput;
}
