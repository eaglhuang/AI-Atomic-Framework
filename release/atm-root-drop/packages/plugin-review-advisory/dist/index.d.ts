...
import { createDeepModuleReviewFingerprint, createDeepModuleReviewReport, deepModuleProviderVocabulary } from './deep-module-provider.ts';
export { checkPromotionSafetyGates } from './promotion-gates.ts';
export { createDeepModuleReviewFingerprint, createDeepModuleReviewReport, deepModuleProviderInfo, deepModuleProviderVocabulary } from './deep-module-provider.ts';
...
export type { DeepModuleDependencyClass, DeepModuleObservedFriction, DeepModuleRefactorCandidate, DeepModuleReviewProviderInput, DeepModuleReviewReport, DeepModuleReviewStatus, DeepModuleTrigger } from './deep-module-provider.ts';
...
declare const _default: {
    ...
    createDeepModuleReviewReport: typeof createDeepModuleReviewReport;
    createDeepModuleReviewFingerprint: typeof createDeepModuleReviewFingerprint;
    deepModuleProviderInfo: {
        readonly providerId: "matt-pocock-deep-module-reference";
        readonly providerVersion: "2026-07-24.ed37663";
        readonly providerContract: "atm.deepModuleRefactorProvider.v1";
        readonly upstreamUrl: "https://github.com/mattpocock/skills";
        readonly upstreamCommit: "ed37663cc5fbef691ddfecd080dff42f7e7e350d";
        readonly codebaseDesignDigest: "sha256:c46b49303a81c7fc8934d0f4fbc44382cdecb73942d85d8d7db3523407fff8fa";
        readonly improveArchitectureDigest: "sha256:d3682058df92c259b47c36503baa02345d5811758621b5dc03081d5ba0f7b69b";
        readonly license: "MIT";
    };
    deepModuleProviderVocabulary: typeof deepModuleProviderVocabulary;
};
