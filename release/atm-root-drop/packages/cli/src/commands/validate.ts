...
function runValidateTaxonomy(repo: string, taskId: string | null) {
  ...
  const taxonomy: Record<string, { scope: string; description: string }> = {};
 ...
 */
export function getValidatorScope(
  gateName: string,
  touchedFiles: readonly string[] = []
): 'task-local' | 'global-advisory' | 'release-blocking' | 'diagnostic' {
