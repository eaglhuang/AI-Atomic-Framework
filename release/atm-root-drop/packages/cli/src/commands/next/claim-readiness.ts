...
export interface ClaimReadinessTaskSummary {
  ...
  /** Canonical planning-card path when a route discovered a Markdown card. */
...
function describeDependencyBlocker(taskId: string, blocker: TaskClaimDependencyBlocker): string {
