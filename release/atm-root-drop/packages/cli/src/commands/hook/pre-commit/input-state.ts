...
export function scanEncoding(cwd: string, files: readonly string[]) {
...
export function inspectTaskCardStatusChanges(cwd: string, stagedFiles: readonly string[]) {
...
export function writeStagedGitHeadEvidence(cwd: string, stagedFiles: readonly string[], commandRuns: readonly CommandRunReport[]) {
