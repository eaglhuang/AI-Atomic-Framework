...
} from './tasks/claim-repair-diagnostics.ts';
import {
...
async function runTasksRepairClaim(argv: string[]): Promise<CommandResult> {
...
function parseRepairClaimOptions(argv: string[]): ParsedRepairClaimOptions {
  const state = {
    cwd: process.cwd(),
