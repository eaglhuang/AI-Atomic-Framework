...
export default defineCommandSpec({
  ...
  help: {
    ...
    commonMistakes: [
      ...
      'Minting a new task id family before scanning existing task-card families; taskflow open reports ATM_TASK_ID_FAMILY_DRIFT when the semantic family already exists.',
