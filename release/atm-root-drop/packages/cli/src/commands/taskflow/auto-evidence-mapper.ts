...
export interface AutoEvidenceCommandMapping {
  ...
  readonly source:
    ...
    | 'declared-verbatim-unrecognized-shape';
 ...
 */
function parseNodeStripTypesInvocation(raw: string): {
  scriptBaseName: string;
  candidateScriptNames: string[];
  tail: string;
} | null {
 ...
 */
export function mapAutoEvidenceCommand(
