...
import { createTeamProposalWorkspaceProviderPlan } from './team/proposal-workspace.ts';
...
export interface TeamWaveRuntimeLane {
  ...
  readonly workspace: ReturnType<typeof createTeamProposalWorkspaceProviderPlan>;
