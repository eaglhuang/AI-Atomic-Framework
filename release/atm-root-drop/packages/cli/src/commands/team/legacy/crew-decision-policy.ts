...
import { mapTeamSizeToLevel } from './implementer-selector-policy.ts';
import {
...
export function buildCaptainDecision(
...
export function normalizeTeamSizeOverride(value: unknown): { teamLevel: TeamLevel; teamSize: 'small' | 'medium' | 'large' } | null {
...
export function evaluateLargeScriptRisk(writePaths: string[]) {
