...
import { CliError, configPathFor, ensureAtmDirectory, makeResult, message, parseOptions, readFrameworkVersion, relativePathFrom, writeJsonFile } from './shared.js';
...
export async function runInit(argv) {
    ...
    const bootstrap = shouldAdoptDefault
