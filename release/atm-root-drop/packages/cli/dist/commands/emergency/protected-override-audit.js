...
export function protectedOverrideAuditRoot(cwd) {
...
export function recordProtectedOverrideAuditEvent(input) {
...
export function recordProtectedOverrideAuthorization(input) {
    return recordProtectedOverrideAuditEvent({
        ...input,
        outcome: 'authorized'
    });
}
export function recordProtectedOverrideCompletion(input) {
    return recordProtectedOverrideAuditEvent(input);
}
export function listProtectedOverrideAuditEvents(cwd, input = {}) {
