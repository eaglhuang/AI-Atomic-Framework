...
import { relativePath, routeContextDir, routeContextPath, sanitizeRouteToken, writeJson } from './files.js';
import { routeFileNamePattern } from './types.js';
export function runLifecycleRoute(options) {
