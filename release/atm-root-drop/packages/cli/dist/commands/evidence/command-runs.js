...
export function collectRecordCommandRuns(record) {
    const out = [];
...
export function readRecordValidationPasses(record) {
...
export function readRecordFreshness(record) {
...
export function readCurrentCommit(cwd) {
...
export function readCommandRunsInputFile(filePath) {
...
export function normalizeCommandRunInput(value, label) {
    if (!isRecord(value)) {
...
export function inferRunnerKindFromCommand(command) {
...
export function uniqueCommandRuns(runs) {
    const seen = new Set();
    const output = [];
