...
import { makeActiveIntent, makeBrokerCloseFixture, writeBrokerRegistry } from './fixtures.js';
...
assert.ok(brokerStaleEpochDryRun.evidence.writeReadinessHint.brokerConflictGate.requiredCommand?.includes('team broker resolve'), 'advisory stale-epoch overlap must point operators to broker resolution');
