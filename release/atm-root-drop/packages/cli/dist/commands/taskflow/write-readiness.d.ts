...
export declare function resolveWriteReadinessValidationContract(task: ValidationContractTask, changeSet: ValidationContractChangeSet, catalog: ValidationContractCatalog, evidence?: ValidationContractEvidence): ValidationContractEvaluation;
