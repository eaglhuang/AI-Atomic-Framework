...
import { planSharedDeliveryCommit } from '../../_vendor/core/dist/broker/shared-delivery-commit.js';
import { assembleSealedCommitIndex, assertCommitAttribution, readCandidateTreeEntries, readCommittedTreeEntries, sealCommitBundleFromLiveIndex } from '../git-governance/implementation/sealed-commit-attribution.js';
import { assertRecordCommitPayloadPresent } from '../git-governance/record-commit-payload-assertion.js';
export const ATM_BROKER_BATCH_COMMIT_BLOCKED = 'ATM_BROKER_BATCH_COMMIT_BLOCKED';
export const ATM_BROKER_BATCH_COMMIT_HEAD_MOVED = 'ATM_BROKER_BATCH_COMMIT_HEAD_MOVED';
