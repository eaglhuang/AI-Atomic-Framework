...
export default defineCommandSpec({
    ...
    options: [
        ...
        { flag: '--planning-root', value: 'path', summary: 'Use one explicit planning authority root and bypass ambiguous sibling discovery for this route.' },
    ...
    examples: [
        ...
        'node atm.mjs next --prompt "implement TASK-ABC-0001" --planning-root C:/planning/docs/ai_atomic_framework --json',
