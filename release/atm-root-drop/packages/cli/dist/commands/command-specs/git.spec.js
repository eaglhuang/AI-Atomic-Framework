...
export default defineCommandSpec({
    ...
    options: [
        ...
        { flag: '--delivery-slice-manifest', value: 'path', summary: 'Optional verified publication delivery-slice manifest. Restricts --auto-stage to outputInventory ∩ current dirty plus receipt-derived required records; same-task certificate/closeout dirt is not absorbed.' },
        { flag: '--delivery-slice-receipt', value: 'path', summary: 'Derive the publication delivery slice directly from the current task canonical published runner-sync receipt; mutually exclusive with --delivery-slice-manifest.' },
    ...
    examples: [
        ...
        'node atm.mjs git commit --actor codex-main --task TASK-AAO-0141 --message "build(runner): record sealed runner publication outputs" --auto-stage --delivery-slice-manifest .atm/history/evidence/TASK-AAO-0141.delivery-slice.json --dry-run --json',
        'node atm.mjs git commit --actor codex-main --task TASK-AAO-0141 --message "build(runner): record sealed runner publication outputs" --auto-stage --delivery-slice-receipt .atm/history/evidence/TASK-AAO-0141.runner-sync-receipt.json --dry-run --json',
