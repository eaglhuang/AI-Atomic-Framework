...
export default defineCommandSpec({
    ...
    options: [
        ...
        { flag: '--surface-kind', value: 'kind', summary: 'Broker schedule surface kind: commit, runner-sync, projection, or checkpoint.' },
        { flag: '--surface-family', value: 'family', summary: 'Broker schedule compatible surface family.' },
        { flag: '--payload-digest', value: 'digest', summary: 'Broker schedule payload digest used in idempotency keys.' },
        { flag: '--manifest-digest', value: 'digest', summary: 'Wave manifest digest for broker batch commit receipts.' },
