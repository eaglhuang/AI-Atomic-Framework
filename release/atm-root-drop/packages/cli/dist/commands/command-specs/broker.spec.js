...
export default defineCommandSpec({
    ...
    options: [
        ...
        { flag: '--persist-merge-plan', summary: 'Persist a broker-computed compose plan to its canonical runtime path; compose is read-only unless this flag is present.' },
    ...
    examples: [
        ...
        'node atm.mjs broker compose --store .atm/runtime/broker-proposals.json --proposal-id proposal-a --proposal-id proposal-b --persist-merge-plan --json',
