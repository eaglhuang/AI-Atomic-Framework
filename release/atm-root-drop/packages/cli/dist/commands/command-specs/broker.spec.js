...
export default defineCommandSpec({
    ...
    positional: [
        { name: 'action', summary: 'register | decision | status | release | cleanup | proposal | compose | steward | runtime | runner-sync | projection | plan-batch | schedule', required: true },
