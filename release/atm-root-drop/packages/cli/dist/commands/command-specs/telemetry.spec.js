...
export default defineCommandSpec({
    ...
    options: [
        ...
        { flag: '--coverage-report', summary: 'Show required governance node coverage and M2 preflight readiness.' },
        { flag: '--m2-preflight', summary: 'Alias for --coverage-report, intended for analyzer preflight.' },
        { flag: '--task-summary', summary: 'Show digest-only per-task gate telemetry summary from sealed history.' },
        ...
        { flag: '--role', value: 'baseline|treatment|m2-preflight|unknown', summary: 'Task summary baseline/treatment role.' },
    ...
    examples: [
        ...
        'node atm.mjs telemetry --coverage-report --json',
        'node atm.mjs telemetry --m2-preflight --json',
        'node atm.mjs telemetry --task-summary --task ATM-GOV-0195 --role m2-preflight --json',
