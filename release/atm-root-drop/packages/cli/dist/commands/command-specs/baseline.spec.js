...
export default defineCommandSpec({
    ...
    options: [
        ...
        { flag: '--framework-commit-range-cut', summary: 'Also write the framework legacy commit-range cut manifest at this baseline commit.' },
    ...
    examples: [
        'node atm.mjs baseline create --name atm-redteam-baseline-2026-05-24 --framework-commit-range-cut --json',
