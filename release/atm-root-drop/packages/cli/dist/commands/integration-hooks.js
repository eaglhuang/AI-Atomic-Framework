...
function extractCommandFromPayload(value) {
...
function readIntegrationManifestIfExists(root, adapterId) {
    return readJsonIfExists(path.join(root, '.atm', 'integrations', `${adapterId}.manifest.json`));
}
...
function isRuntimeLockStatePath(value) {
...
function buildPromptScopedPlanningMirrorPaths(tasks) {
