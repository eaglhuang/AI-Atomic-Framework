...
assert.ok(existsSync(path.join(repo, '.atm/history/task-events', taskId, `${taskAfter.lastTransitionId}.json`)), 'direction-lock cleanup must create a matching task-event file');
