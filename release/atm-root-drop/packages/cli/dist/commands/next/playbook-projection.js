...
import { describeIntegrationInstallHint } from '../integration.js';
import { allowedGuidanceBootstrapCommands, blockedMutationCommands } from './channel-strategy.js';
import { ensureDecisionTrail, readTaskId } from './next-action-assembly.js';
...
import { dedupeStrings, quoteCliValue, toTaskCandidateView, uniqueSorted } from './view-projections.js';
...
export function inspectFreshTaskReservationForTask(cwd, task, currentActorId, now) {
...
export function embedTeamRecommendation(nextAction, input) {
...
export function buildNextMessages(nextAction, userNotice, integrationBootstrap, runtimeAdapterReadiness, routeMessage) {
