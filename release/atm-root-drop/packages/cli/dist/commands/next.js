...
import { inspectBatchRunConsistency, isQuickfixPrompt, readActiveBatchRun, writeBatchRun, writeQuickfixLock } from './work-channels.js';
...
import { CliError, makeResult, message, parseOptions, resolveNextDefaultOutputPath, setOutputJsonPath } from './shared.js';
...
import { normalizeTaskRouteStatus } from './next/intent-normalizers.js';
import { canTaskBePreparedForClaim, isFrameworkMaintenancePrompt, isTaskAlreadyActivelyClaimed } from './next/route-predicates.js';
import { quoteCliValue, toTaskCandidateView, uniqueInOrder, uniqueSorted } from './next/view-projections.js';
import { buildNonPlaybookRouteHints, checkPendingTaskArtifactScopeExpansion, createDeterministicTaskIntent, findActiveBatchRunForIntent, findActiveTaskQueueForIntent, hasPromptScopedWorkItems, assertPromptBatchDoesNotConflict, inspectImportedTaskQueue, reconcilePromptScopeRuntimeForClaim, resolveTaskIntent, resolveQuickfixScope } from './next/route-resolution.js';
import { buildActiveTaskDivergenceResult, buildActiveWorkSummary, buildAgentPackHint, buildChannelPlaybook, buildGovernanceReadinessHint, buildNextMessages, buildTaskDeliveryPrinciple, embedTeamRecommendation, enrichWithLegacyPlan, inspectFreshTaskReservationForTask, normalizeWorkPath, shouldInspectCrossRepoFrameworkStatus } from './next/playbook-projection.js';
