...
import { normalizePath, normalizeWhitespace, readSnippet, stringOption, tokenize } from './text-utils.js';
...
export function rankKnowledgeHits(entries, query, filters, top, cwd) {
...
export function buildHybridRequest(options) {
...
export function summarizeHitReason(hit, taskId) {
...
export function deriveQueryText(cwd, options) {
