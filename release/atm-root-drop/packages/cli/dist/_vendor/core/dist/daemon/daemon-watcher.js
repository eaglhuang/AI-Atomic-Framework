...
import { isDaemonEnabled, appendDaemonNotification, writeDaemonPid, getDaemonDir } from './daemon-config.js';
export function buildDefaultWatchPaths(repositoryRoot) {
    const paths = [];
    const candidates = [
...
export function startDaemonWatcher(config) {
...
function handleFileChange(repositoryRoot, fullPath, filename, eventType) {
