...
export function buildValidationReceiptInput(input) {
    ...
    let failureReason = typeof input.result.failureReason === 'string' ? input.result.failureReason : null;
    let recoveryRoute = typeof input.result.recoveryRoute === 'string' ? input.result.recoveryRoute : null;
