import { evaluateMutationGate } from '../../core/dist/guidance/index.js';
import { EVOLVE_DELEGATION_TARGET } from './behavior.js';
/**
...
export class BehaviorRegistry {
    ...
    resolve(action) {
        for (const behavior of this._behaviors.values()) {
            if (behavior.actionCategories.includes(action)) {
                return behavior;
            }
        }
        return null;
     ...
     */
    async executeGuarded(context, input) {
...
function evaluateBehaviorMutationGate(input) {
