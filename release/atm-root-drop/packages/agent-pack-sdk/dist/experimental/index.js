export const experimentalApiSchemaVersion = 'atm.experimentalApi.v0.1';
...
/** @experimental */
export const experimentalApis = Object.freeze([
    {
...
/** @experimental */
export function listExperimentalApis() {
    return experimentalApis;
}
/** @experimental */
export function invokeExperimentalApi(input) {
