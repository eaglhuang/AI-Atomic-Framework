...
import { admitWave, type WaveAdmissionMemberInput } from '../team-wave-admission.ts';
...
function intent(taskId: string, atomCid: string): WriteIntent {
  return {
...
function member(over: Partial<WaveAdmissionMemberInput> & { card: WaveCandidateCard }): WaveAdmissionMemberInput {
