...
import { createPatchEnvelope } from '../patch-envelope.ts';
import {
  annotateForAtmCore,
  validateAtmCorePatchEnvelope
} from '../patch-envelope-atm-core.ts';

function base(over: Partial<Parameters<typeof createPatchEnvelope>[0]> = {}) {
