...
import { ReplacementMode } from './constants.ts';
import {
  appendTransitionRecord,
  createReplacementLaneError,
  ...
  normalizeTimestamp,
  resolveRegistryLifecycleStatus,
  writeJson
} from './support.ts';
import { loadReplacementLaneTarget } from './target.ts';
import type { ReplacementLaneEvidenceInput, ReplacementLaneOptions } from './types.ts';
import { validateTransition } from './validation.ts';
