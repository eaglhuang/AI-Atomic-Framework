...
function atomCatalogEntry(repoPath: string, atomId: string, entry: RegistryEntryRecord | null, existing: readonly AtomCatalogEntry[]): AtomCatalogEntry {
  return {
    kind: 'atom',
    id: atomId,
...
function addMapMemberAtoms(repoPath: string, entry: AtomCatalogEntry, registryAtomIds: ReadonlySet<string>, entries: AtomCatalogEntry[]) {
