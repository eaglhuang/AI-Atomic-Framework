...
export type ProposalAdmissionTrigger = 'not-required' | 'hot-file' | 'same-file-overlap-risk' | 'shared-surface-risk' | 'manual-review-surface';
export type ProposalAdmissionState = 'not-required' | 'proposal-submitted' | 'provisional-write-lease' | 'write-admitted' | 'composer-routed' | 'blocked-before-write' | 'parked-for-rearbitration' | 'applied';
