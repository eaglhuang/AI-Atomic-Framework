...
import { pairBlockReasons } from './team-wave-planner.js';
import { evaluateConflictMatrix } from './conflict-matrix.js';
const BLOCK_REASON_TO_CATEGORY = {
 ...
 */
export function admitWave(input) {
...
function toActiveIntent(intent) {
