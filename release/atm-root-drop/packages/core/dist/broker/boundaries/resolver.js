import { sha256Text } from './content-anchor.js';
...
function findCandidates(anchor, sourceText, adapter) {
...
function findTextMatches(anchor, sourceText) {
...
function filterByPreimage(anchor, sourceText, candidates) {
    const lines = sourceText.split(/\r?\n/);
...
function contextMatches(anchor, lines, start, length) {
...
function resolution(anchor, status, filePath, candidates, reason, currentFileDigest) {
    return {
