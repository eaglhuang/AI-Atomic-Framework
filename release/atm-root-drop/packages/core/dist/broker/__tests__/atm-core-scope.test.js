...
import { analyzeAtmCoreScope, applyAtmScopeClassOverride, classifyAtmCorePath, deriveAtmScopeClass } from '../atm-core-scope.js';
...
assert.deepEqual(deriveAtmScopeClass(['docs/plan.md', '.atm/history/tasks/ATM-GOV-0159.json', 'packages/cli/src/atm.ts']).scopeClass, ['code', 'docs', 'ledger']);
