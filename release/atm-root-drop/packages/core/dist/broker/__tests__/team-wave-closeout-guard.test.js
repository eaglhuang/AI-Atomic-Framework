...
import { assertCoordinatorOnly } from '../../../../cli/dist/commands/team-wave.js';
const privilegedActions = ['git-write', 'task-closeout', 'checkpoint'];
const nonCoordinatorRoles = ['worker', 'validator', 'reviewer'];
