...
import { FALLBACK_ADAPTER_ID, createAdapterRegistry, defaultAdapterRegistry, registerAdapter, resolveAdapter } from '../adapters/index.js';
import { brokerAdapterMigration } from '../types.js';
function makeFile(filePath, content = '') {
    return { filePath, content };
}
function makeStubAdapter(id, predicate) {
    return {
        id,
        supports: predicate,
