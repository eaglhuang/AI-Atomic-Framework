...
function makeMergePlan(overrides) {
    return {
...
function runTests() {
    ...
    // ---------------------------------------------------------------------------
    {
        const identity = { stewardId: 'neutral-write-steward', kind: 'neutral' };
    ...
    // ---------------------------------------------------------------------------
    {
        const identity = { stewardId: '', kind: 'neutral' };
        const result = checkStewardPermission(identity);
    ...
    // ---------------------------------------------------------------------------
    {
        const identity = { stewardId: 'runner-broker', kind: 'derived-artifact-writer' };
        const result = checkStewardPermission(identity);
