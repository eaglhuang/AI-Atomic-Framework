...
import { cleanupRunnerSyncStewardQueue, emptyRunnerSyncStewardQueue, enqueueRunnerSyncStewardRequest, explainRunnerSyncStewardPosition, releaseRunnerSyncStewardQueue } from '../runner-sync-steward-queue.js';
...
function testReleaseRequiresReceiptQueueHeadAndWaitingTask() {
    ...
    assert.throws(() => releaseRunnerSyncStewardQueue(waiting.queue, {
        taskId: 'TASK-A',
