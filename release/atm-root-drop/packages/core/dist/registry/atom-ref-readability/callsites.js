...
import { readText, walkSourceFiles, writeText } from './files.js';
export function scanCallsites(repoPath) {
...
export function collectDefinedReadableRefs(repoPath) {
    const names = new Set();
...
export function planCallsiteRewrites(callsites, catalog) {
...
export function evaluateCallsites(callsites, knownRefNames, plannedRewrites) {
...
export function applyCallsiteRewrites(repoPath, rewrites) {
...
function evaluateOneCallsite(callsite, knownRefNames, rewriteKeys) {
