...
function loadReplacementLaneTarget(repositoryRoot, mapId) {
...
function loadEvidenceDocuments(repositoryRoot, evidenceRefs) {
...
function findMapEquivalenceEvidence(mapId, evidenceDocuments) {
...
function findPropagationEvidence(mapId, evidenceDocuments) {
...
function findRollbackProofEvidence(mapId, evidenceDocuments) {
...
function findRetirementProofEvidence(mapId, evidenceDocuments) {
...
function appendTransitionRecord(existingLog, input) {
...
function isReplacementModeValue(value) {
    return orderedReplacementModes.includes(value);
}
function requiresEvidence(mode) {
...
function mergeStringArrays(...groups) {
...
function defaultTransitionReason(from, to) {
    return `Replacement lane transition ${from} -> ${to}.`;
}
function resolveRegistryLifecycleStatus(targetMode, currentStatus) {
    switch (targetMode) {
...
function createReplacementLaneError(code, message, details) {
