...
export declare const behaviorRollbackContract: Readonly<{
    readonly 'behavior.evolve': "behavior.rollback-evolve";
    readonly 'behavior.merge': "behavior.rollback-merge";
    readonly 'behavior.atomize': "behavior.rollback-atomize";
    readonly 'behavior.infect': "behavior.rollback-infect";
}>;
