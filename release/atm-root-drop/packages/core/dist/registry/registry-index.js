import { normalizeSemanticFingerprint, semanticFingerprintPrefix } from './semantic-fingerprint.js';
import { formatAtmUrn, normalizeAtmNodeRef } from './urn.js';
...
function addMemberVersions(index, atomIdIndex, members) {
