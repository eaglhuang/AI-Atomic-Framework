...
export function inferInputKind(kindOrSchemaId) {
...
export function unwrapKnownInputDocument(document) {
...
export function resolveInputSchemaId(kind, document) {
...
export function createInputSummary(kind) {
    switch (kind) {
        case 'hash-diff':
...
export function normalizeInputDocument(input) {
...
export function requireInput(inputs, expectedKind) {
...
export function buildInputRefs(inputs) {
    return [...inputs]
        .sort((left, right) => {
