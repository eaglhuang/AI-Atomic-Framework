...
export const OBLIGATION_INVENTORY_SCHEMA_ID = 'atm.obligationInventory.v1';
export const OBLIGATION_INVENTORY_DRIFT_SCHEMA_ID = 'atm.obligationInventoryDrift.v1';
export function createObligationInventory(input) {
...
export function detectObligationInventoryDrift(input) {
    ...
    const sortedItems = items.sort((left, right) => left.obligationId.localeCompare(right.obligationId) || left.kind.localeCompare(right.kind));
    return {
...
function indexByObligationId(entries) {
