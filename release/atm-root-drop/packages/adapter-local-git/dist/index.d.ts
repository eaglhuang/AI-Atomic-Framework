...
import type { AtomizeAdapterRequest, HostGate, InfectAdapterRequest, MutationPolicy, NoTouchZone, GovernancePluginResult, ProjectAdapter as SdkProjectAdapter, ProjectAdapterContext as SdkProjectAdapterContext, ProjectAdapterDryRunResult as SdkProjectAdapterDryRunResult, ProjectAdapterLegacyUriResolution, ProjectAdapterResult as SdkProjectAdapterResult } from '@ai-atomic-framework/plugin-sdk';
export declare const adapterLocalGitPackage: {
    readonly packageName: "@ai-atomic-framework/adapter-local-git";
    readonly packageRole: "local-git-adapter";
...
export declare const defaultLocalGitAdapterConfig: LocalGitAdapterConfig;
export declare const localGitAdapterRuntime: {
    readonly entrypoint: "./local-git-adapter.ts";
    readonly supportsFilesystemRegistryPath: true;
    readonly hostGovernanceRequired: false;
    readonly noopOperations: readonly ["lock", "gate", "doc"];
    readonly resultFormat: "LocalGitAdapterResult";
};
