...
Generated: 2026-07-17T08:26:37.353Z
...
- Framework temp claims: 29 retained runtime lock files observed; 1 fresh, 28 stale. This is a runtime snapshot over retained lock files, not an append-only framework claim history; it must not be merged into task-event throughput.
