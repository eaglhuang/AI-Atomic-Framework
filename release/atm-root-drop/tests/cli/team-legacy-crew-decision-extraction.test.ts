...
const legacyPreviousLineCount = 3628;
...
assert.ok(
  ...
  `team-legacy.ts should shrink below its TASK-RFT-0041 baseline ${legacyPreviousLineCount}; got ${legacyLines}`
);
...
console.log('[team-legacy-crew-decision-extraction:test] ok');
