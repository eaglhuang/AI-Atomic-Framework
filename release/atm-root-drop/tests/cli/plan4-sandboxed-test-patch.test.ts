...
const result = compileSandboxedTestPatch({ authority, patchId: 'p', sourceDigest: 'sha256:source', operations: [{ operationId: 'large', path: 'test.ts', start: 4, end: 20, replacement: 'x' }, { operationId: 'small', path: 'test.ts', start: 0, end: 3, replacement: 'y' }], requiredTestIds: ['t1'], passingTestIds: ['t1'], provenance: { actor: 'ignored' } });
