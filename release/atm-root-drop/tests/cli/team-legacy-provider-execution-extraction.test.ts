...
const legacyPreviousLineCount = 4019;
...
assert.ok(
  ...
  `team-legacy.ts should shrink below its TASK-RFT-0040 baseline ${legacyPreviousLineCount}; got ${legacyLines}`
);
...
console.log('[team-legacy-provider-execution-extraction:test] ok');
