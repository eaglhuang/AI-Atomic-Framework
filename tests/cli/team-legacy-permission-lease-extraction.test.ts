...
const legacyPreviousLineCount = 4213;
...
assert.ok(
  ...
  `team-legacy.ts should shrink below its TASK-RFT-0039 baseline ${legacyPreviousLineCount}; got ${legacyLines}`
);
...
console.log('[team-legacy-permission-lease-extraction:test] ok');
