...
assert.equal(report.totals.unresolvedObjectiveRows, 70);
...
assert.equal(report.totals.plan3xPositiveReceiptRowsConsumedIntoSourceReplay, 16);
assert.equal(report.totals.plan3xObjectiveAlignedNegativeControlRowsConsumed, 5);
