...
assert.equal(report.totals.unresolvedObjectiveRows, 72);
...
assert.equal(report.totals.plan3xPositiveReceiptRowsConsumedIntoSourceReplay, 14);
assert.equal(report.totals.plan3xObjectiveAlignedNegativeControlRowsConsumed, 3);
