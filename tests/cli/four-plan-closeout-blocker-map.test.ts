...
assert.equal(report.totals.unresolvedObjectiveRows, 69);
...
assert.equal(report.totals.plan3xPositiveReceiptRowsConsumedIntoSourceReplay, 17);
assert.equal(report.totals.plan3xObjectiveAlignedNegativeControlRowsConsumed, 6);
