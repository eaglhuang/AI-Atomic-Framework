...
assert.equal(report.totals.unresolvedObjectiveRows, 66);
...
assert.equal(report.totals.plan3xPositiveReceiptRowsConsumedIntoSourceReplay, 20);
assert.equal(report.totals.plan3xObjectiveAlignedNegativeControlRowsConsumed, 7);
