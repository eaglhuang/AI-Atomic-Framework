...
assert.equal(report.totals.unresolvedObjectiveRows, 71);
...
assert.equal(report.totals.plan3xPositiveReceiptRowsConsumedIntoSourceReplay, 15);
assert.equal(report.totals.plan3xObjectiveAlignedNegativeControlRowsConsumed, 4);
