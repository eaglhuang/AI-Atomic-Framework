...
assert.ok(
  ...
  `team-legacy.ts should shrink below its TASK-RFT-0038 baseline ${legacyPreviousLineCount}; got ${legacyLines}`
);
...
console.log('[team-legacy-patrol-contract-extraction:test] ok');
