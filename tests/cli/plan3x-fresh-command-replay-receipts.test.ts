...
assert.equal(report.familyDisposition.focusedCommandsExecuted, 29);
assert.equal(report.familyDisposition.commandsGreen, 29);
assert.equal(report.familyDisposition.rowsConsumedIntoSourceReplay, 50);
...
assert.equal(report.commandRuns.length, 29);
