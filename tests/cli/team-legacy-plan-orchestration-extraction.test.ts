...
const legacyPreviousLineCount = 2975;
...
assert.ok(
  ...
  `team-legacy.ts should shrink below its TASK-RFT-0042 baseline ${legacyPreviousLineCount}; got ${legacyLines}`
);
...
console.log('[team-legacy-plan-orchestration-extraction:test] ok');
