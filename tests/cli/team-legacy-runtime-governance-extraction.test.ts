...
const legacyTargetLineCount = 2000;
...
assert.ok(
  legacyLines < legacyTargetLineCount,
  `team-legacy.ts should shrink below ${legacyTargetLineCount}; got ${legacyLines}`
);
...
console.log('[team-legacy-runtime-governance-extraction:test] ok');
