...
try {
  ...
  writeFileSync(path.join(legacyWorkbench, 'map.integration.test.mjs'), "console.log('legacy map integration ok');\n", 'utf8');
...
function writeCanonicalFixtureMap(repositoryRoot, fixture, shouldPass) {
