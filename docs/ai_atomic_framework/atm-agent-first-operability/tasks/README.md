...
| `TASK-AAO-0002` | CLI command spec / runner SSOT drift guard | M1 | done | `TASK-AAO-0001`, `TASK-ASA-0009` | CLI surface | none |
| `TASK-AAO-0003` | `next` decisionTrail JSON contract | M1 | done | `TASK-AAO-0001`, `TASK-ASA-0009` | CLI JSON | none |
| `TASK-AAO-0004` | validator failure envelope standardization | M2 | done | `TASK-AAO-0001`, `TASK-ASA-0010` | validators | none |
