...
- Coordinating implementation task cards, planning queues, task-card import notes, and downstream operating notes do not live in the framework protected surface.
...
| Coordinating implementation task cards, planning queues, or task-card import notes | Remove from protected surface | Coordinating host workspace or downstream transfer workspace |
