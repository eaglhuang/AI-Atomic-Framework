...
export interface CSharpLanguageAdapter
  extends LanguageAdapter<CSharpProjectProfile, CSharpLanguageAdapterValidationRequest, CSharpLanguageAdapterValidationReport> {
...
export const defaultCSharpImportPolicy: CSharpImportPolicy = {
  forbiddenSpecifiers: []
};
...
export {
  createAllCSharpStaticCheck,
  createCSharpCommandRunnerContract,
  createCSharpLanguageAdapter,
  createDefaultCSharpStaticCheck,
  createFastCSharpStaticCheck,
  defaultCSharpLanguageAdapterManifest,
  detectCSharpProjectProfile,
  scanCSharpEntrypoints,
  scanCSharpImports,
  validateCSharpComputeAtom
} from './language-csharp-adapter.ts';
