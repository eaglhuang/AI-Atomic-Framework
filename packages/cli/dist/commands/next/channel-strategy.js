...
export function allowedGuidanceBootstrapCommands() {
    return [
...
export function blockedMutationCommands() {
    return [
...
export function decideRuntimeNextAction(runtime, failedCheckName, importedTaskQueue) {
...
export function selectQuickfixChannel() {
    return {
...
export function selectBatchChannel(reason) {
    return {
        schemaId: 'atm.nextChannelStrategy.v1',
        channel: 'batch',
...
export function selectNormalTaskRouteChannel(reason) {
    return {
        schemaId: 'atm.nextChannelStrategy.v1',
...
export function selectPostClaimChannel(batchActive) {
    if (batchActive) {
...
export function selectUnknownRuntimeChannel() {
    return {
        schemaId: 'atm.nextChannelStrategy.v1',
        channel: 'normal',
        recommendedChannel: 'normal',
 ...
 */
export function channelStrategyPreservesInput(input, selector) {
