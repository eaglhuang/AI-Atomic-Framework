...
export const teamSpecCommandSurface = {
    ...
    options: [
        ...
        { flag: '--batch', value: 'id', summary: 'For team wave plan/dispatch: consume the selected batch run as the wave manifest source.' },
        ...
        { flag: '--wave', value: 'id', summary: 'For team wave plan/dispatch: deterministic wave id from the batch selector.' },
        { flag: '--worker-report', value: 'path', repeatable: true, summary: 'For team wave dispatch: worker report JSON to reconcile into the executor-neutral runtime result.' },
        commonJsonOption,
        commonPrettyOption,
        commonHelpOption
    ]
...
export const teamSpecPlanResolver = {
    summary: 'Plan examples for the TASK-TEAM-0009 dry-run resolver output, including the team implementer selector and atm.teamPlan.v1 evidence surface.',
    examples: ['node atm.mjs team plan --task TASK-TEAM-0009 --json']
};
export const teamSpecRoleSelector = {
    summary: 'Plan examples for deterministic role and implementer selection output with language, role, fallback, and confidence signals (TASK-TEAM-0010 owns the selector surface).',
