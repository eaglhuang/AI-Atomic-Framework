...
export default defineCommandSpec({
    ...
    options: [
        ...
        { flag: '--emergency-approval', value: 'leaseId', summary: 'For checkpoint: forward a protected backend close approval lease when historical delivery closeback requires one.' },
