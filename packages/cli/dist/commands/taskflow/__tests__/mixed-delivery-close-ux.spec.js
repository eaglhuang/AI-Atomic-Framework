...
assert.equal(writePrioritized[0]?.code, 'ATM_TASK_CLOSE_DELIVERABLE_DIFF_REQUIRED', 'write admission must preserve the backend delivery gate ahead of a shared-delivery waiver');
