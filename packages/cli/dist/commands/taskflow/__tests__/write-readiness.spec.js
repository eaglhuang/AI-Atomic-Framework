...
assert.ok(planningReadOnlyHint.blockers.every((entry) => entry.code !== 'ATM_WRITE_TICKET_SCOPE_VIOLATION'), 'target work admission must evaluate the target delivery set, not read-only planning declarations');
