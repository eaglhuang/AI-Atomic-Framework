...
export function closeTransactionStatusPath(cwd, taskId) { return path.join(cwd, '.atm', 'runtime', 'close-transactions', `${taskId}.json`); }
export function writeCloseTransactionStatus(input) {
