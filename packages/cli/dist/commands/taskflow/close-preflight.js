...
import { evaluatePhaseSuitePromotion } from '../../_vendor/core/dist/evidence/phase-suite.js';
import { inspectStandardsSpecReviewReceipt } from '../../_vendor/plugin-review-advisory/dist/index.js';
...
import { applyCloseOwnedNonRunnerDeliveryDirtyAdmission, extractCloseOwnedDeliveryFiles } from './close-owned-delivery-dirty-admission.js';
...
function readStandardsSpecReviewReport(cwd, taskId) {
...
function digestTaskCandidate(cwd, files) {
 ...
 */
export function validationContractDigest(evaluation) {
 ...
 */
export function evaluateValidatorReviewLifecycleGate(input) {
