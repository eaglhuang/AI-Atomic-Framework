...
export { createCommitRangeGuardReport, findFutureCommitEvidenceMatchInWorktree, readCurrentHeadForFutureCommit, readGitObjectText, readJsonText, readStagedTreeWithoutEvidence } from './commit-range-guard/implementation.ts';
