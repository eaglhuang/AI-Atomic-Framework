...
import { createCommitRangeGuardReport, isAncestorCommit, normalizeOptionalText, parseCommitRangeArgs } from '../commit-range-guard.js';
...
assert.throws(() => parseCommitRangeArgs(['commit-range', '--base', base]), (error) => error instanceof CliError);
