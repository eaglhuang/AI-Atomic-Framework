import { ATM_BROKER_STEWARD_RECEIPT_INVALID, ATM_BROKER_STEWARD_RECEIPT_REQUIRED, type SharedWriteAdmissionDecision } from '../../../../../core/src/broker/shared-write-provenance-policy.ts';
import { readActiveTaskDirectionLocks } from '../../task-direction.ts';
interface SameFileClaimOwnershipFinding {
    readonly code: 'ATM_PRE_COMMIT_STAGED_OWNERSHIP_AMBIGUOUS' | 'ATM_PRE_COMMIT_CLOSEOUT_ONLY_CLAIM_MUTATION' | typeof ATM_BROKER_STEWARD_RECEIPT_REQUIRED | typeof ATM_BROKER_STEWARD_RECEIPT_INVALID;
