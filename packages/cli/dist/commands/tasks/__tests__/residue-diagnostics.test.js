...
import { buildResidueClassification, buildResidueDiagnosisEvidenceFromTriangulation } from '../residue-diagnostics.js';
...
try {
    ...
    writeFileSync(path.join(repo, '.atm', 'history', 'evidence', 'TASK-RES.closure-packet.json'), `${JSON.stringify({ schemaId: 'atm.closurePacket.v1', taskId: 'TASK-RES' }, null, 2)}\n`, 'utf8');
