...
import { extractPathLikeStringsFromPrompt, readActiveQuickfixLock, releaseQuickfixLock, writeQuickfixLock } from './work-channels.js';
export async function runQuickfix(argv) {
