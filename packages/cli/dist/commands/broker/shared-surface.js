...
export function shouldQueueSharedSurface(decision) {
...
export function replaceIntentLane(registry, taskId, lane) {
    return {
        ...registry,
        activeIntents: registry.activeIntents.map((intent) => intent.taskId === taskId ? { ...intent, lane } : intent)
    };
}
export function assertBrokerRegisterCliParity(intent, options) {
    const mismatches = [];
...
export function syncTeamRunRearbitrationSnapshots(cwd, registry, triggerTaskId, triggerActorId) {
