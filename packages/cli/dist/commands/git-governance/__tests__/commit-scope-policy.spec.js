...
assert.equal(pathMatchesTaskScope('packages/cli/src/commands/next/playbook-projection/foo.ts', 'packages/cli/src/commands/next/playbook-projection/**/*.ts'), true);
assert.equal(pathMatchesTaskScope('packages/cli/src/commands/next/playbook-projection/nested/bar.ts', 'packages/cli/src/commands/next/playbook-projection/**/*.ts'), true);
assert.equal(pathMatchesTaskScope('packages/cli/src/commands/next/playbook-projection/foo.js', 'packages/cli/src/commands/next/playbook-projection/**/*.ts'), false);
