...
import { isExplicitTerminalHistoryCleanupArtifact } from './terminal-history-cleanup.js';
...
function isUncommittableTaskEvidenceArtifact(cwd, filePath, taskId, taskDocument, terminalHistoryCleanupAllowed = false) {
...
export function resolveTaskScopedCommitBundle(input) {
    ...
    const inScopeStagedFiles = stagedFiles.filter((filePath) => !isUncommittableTaskEvidenceArtifact(input.cwd, filePath, input.taskId, input.taskDocument, isAllowedCommitArtifact(filePath)) &&
