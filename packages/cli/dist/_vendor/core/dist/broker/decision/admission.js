export function buildProposalAdmissionBase(intent) {
...
export function finalizeProposalAdmission(base, preferredState, overrides) {
...
export function defaultProposalAdmissionRequest() {
    return {
...
export function normalizeBoundedRegions(values) {
    return values
