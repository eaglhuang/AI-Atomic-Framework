...
export const envRegistry: ReadonlyArray<EnvVarDescriptor> = Object.freeze([
  {
    name: 'ATM_TEMP_ROOT',
    surface: 'public',
    kind: 'path',
...
export function findEnvDescriptor(name: string): EnvVarDescriptor | undefined {
 ...
 */
export function readEnvVar(name: EnvVarDescriptor['name']): string | undefined {
