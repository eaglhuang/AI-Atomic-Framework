...
try {
  ...
  const adoptEvidence = adoptResult.evidence as {
    readonly action: string;
    readonly laneSession: { readonly exportHint: string };
    readonly session: { readonly status: string };
    readonly event: { readonly action: string };
