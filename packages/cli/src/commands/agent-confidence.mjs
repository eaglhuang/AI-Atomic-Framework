...
import { relativePathFrom } from './shared.mjs';
...
export function verifyAgentsMarkdown(cwd) {
...
export function createAgentConfidenceEvidence(profile, criteria, agentsMdVerification) {
