...
export function setSummaryProjection(enabled: boolean): void {
  globalSummaryProjection = enabled;
}

export function setFieldsProjection(fields: string[] | null): void {
  globalFieldsProjection = fields;
}

export function getOutputProjectionState(): { outputJsonPath: string | null; summary: boolean; fields: string[] | null } {
