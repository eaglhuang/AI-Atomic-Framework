...
export function verifyEmergencyGitAuthorContinuity(input: {
  readonly expectedGitName: string;
  readonly expectedGitEmail: string;
  readonly observedAuthorName: string | null | undefined;
  readonly observedAuthorEmail: string | null | undefined;
  readonly observedCommitterName?: string | null | undefined;
  readonly observedCommitterEmail?: string | null | undefined;
  readonly atmActorTrailer?: string | null | undefined;
  readonly expectedActorId?: string | null | undefined;
}): { readonly ok: boolean; readonly recoveryCommand: string | null; readonly reason: string | null } {
