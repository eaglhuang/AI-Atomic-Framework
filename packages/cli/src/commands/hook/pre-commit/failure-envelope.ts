...
export function buildPreCommitBlockingFindings(input: Record<string, unknown>): readonly PreCommitBlockingFinding[] {
...
export function selectActionableResidueFindings(input: Record<string, unknown>): readonly Record<string, unknown>[] {
...
export function buildPreCommitFailureEnvelope(input: Record<string, unknown>): PreCommitFailureEnvelope {
