...
function runNpmBuildAfterAdmission(cwd: string): CommandRunRecord {
...
function normalizeActiveCaptains(values: readonly string[]): readonly string[] {
...
function readActiveReleaseCaptainsFromEnv(stewardActorId: string): readonly string[] {
