...
import { runHelloWorldSmoke } from './test.ts';
import { runVerify } from './verify.ts';
import { CliError, makeResult, message, parseOptions, relativePathFrom, resolveValue } from './shared.ts';
...
async function materializeSelfHostingArtifacts(cwd: any, bootstrapEvidence: any, helloWorld: any, neutrality: any, criteria: any, ok: any) {
  ...
  await resolveValue(adapter.stores.logStore.appendLog(
    bootstrapTaskId,
