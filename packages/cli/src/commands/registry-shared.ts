...
import { createSourceHashSnapshot } from '../../../core/src/hash-lock/hash-lock.ts';
import { createRegistryDocument, evaluateRegistryEntryDrift, validateRegistryDocumentFile } from '../../../core/src/registry/registry.ts';
...
export const seedRegistryEvidencePath = 'scripts/validate-seed-registry.ts';
