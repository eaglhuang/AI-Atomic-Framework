...
export function resolveATMChartSchemaSource(relativeSchemaPath: string): {
  readonly kind: 'filesystem' | 'bundled';
  ...
  const embedded = embeddedATMChartSchemaAssets[relativeSchemaPath as keyof typeof embeddedATMChartSchemaAssets];
