...
export function higherVersion(left: string, right: string | null): string {
...
export function highestVersion(left: string, right: string | null): string {
  return higherVersion(left, right);
}

/** Normalize an unknown value into a trimmed semver string or null. */
export function asOptionalVersion(value: unknown): string | null {
