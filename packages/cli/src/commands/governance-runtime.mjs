...
export function detectGovernanceRuntime(cwd, taskId = bootstrapTaskId) {
...
export function createCurrentTaskRecord(task, options = {}) {
  return {
...
function inferCurrentTaskId(cwd, layoutVersion) {
...
function readActiveLock(cwd, layoutVersion, currentTaskId) {
...
function findLatestTimestamp(directoryPath) {
