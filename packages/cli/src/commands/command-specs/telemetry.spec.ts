...
export default defineCommandSpec({
  ...
  options: [
    ...
    { flag: '--shared-write-coverage', summary: 'Show canonical shared-write gate producer coverage with unavailable receipts.' },
  ...
  examples: [
    ...
    'node atm.mjs telemetry --shared-write-coverage --json',
