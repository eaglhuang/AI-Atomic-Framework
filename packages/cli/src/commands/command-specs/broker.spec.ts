...
export default defineCommandSpec({
  name: 'broker',
  summary: 'Manage write intents, proposal capsules, compose merge plans, steward apply, and inspect the local write-broker registry.',
  positional: [
    { name: 'action', summary: 'register | decision | status | release | cleanup | proposal | compose | steward', required: true },
  ...
  options: [
    ...
    { flag: '--scope-file', value: 'path', summary: 'Scoped file-write target allowed for steward apply. Repeatable.' },
    { flag: '--steward-id', value: 'id', summary: 'Neutral write steward identifier.' },
    { flag: '--evidence-out', value: 'path', summary: 'Output path for steward apply evidence JSON.' },
