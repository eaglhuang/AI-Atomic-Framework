...
import {
  countHistoricalDeliveryFiles,
  hasHistoricalDeliveryWaiver,
  type HistoricalDeliveryProvenance
} from '../historical-delivery-provenance.ts';

function provenance(overrides: Partial<HistoricalDeliveryProvenance> = {}): HistoricalDeliveryProvenance {
  return {
...
assert.equal(
  hasHistoricalDeliveryWaiver(provenance({
...
assert.equal(
  countHistoricalDeliveryFiles(provenance({
