...
import { assertTaskCloseAllowedByDirection, advanceTaskQueueAfterClose } from '../task-direction.ts';
...
import { inspectHistoricalDelivery, pathMatchesTaskScope } from './historical-delivery.ts';
import {
...
import { resolveCloseHistoricalContext } from './close-orchestrator/historical-context.ts';
...
export async function runTasksClose(argv: string[]) {
  ...
  } = resolveCloseHistoricalContext(options);
  ...
  let closurePacketPath: string | null = preparedClosurePacket.closurePacketPath;
  let closurePacket: ClosurePacket | null = preparedClosurePacket.closurePacket;
  const pendingClosurePacket: ClosurePacket | null = preparedClosurePacket.pendingClosurePacket;
