...
import {
  createTeamWaveEnvelope,
  validateTeamWaveEnvelope,
  closeReadyMembers,
  type TeamWaveMemberEnvelope
} from '../team-wave-envelope.ts';

function member(over: Partial<TeamWaveMemberEnvelope> & { taskId: string }): TeamWaveMemberEnvelope {
  return {
    taskId: over.taskId,
