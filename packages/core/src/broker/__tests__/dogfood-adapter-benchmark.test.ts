...
import { planMutationBatch } from '../adapters/batch-planner.ts';
...
function makeRequest(o: Partial<MutationRequest> & Pick<MutationRequest, 'requestId' | 'filePath' | 'op' | 'target'>): MutationRequest {
  return {
