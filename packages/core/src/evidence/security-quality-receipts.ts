...
export function compileSecurityQualityReceipts(input: SecurityQualityInput): SecurityQualityResult {
  ...
  if (!n.authority.authorityId || !n.authority.digest || !n.authority.sealed) diagnostics.push('authority-incomplete');
