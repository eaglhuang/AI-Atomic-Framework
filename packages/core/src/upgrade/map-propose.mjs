...
export function buildMapProposalContext({ repositoryRoot, mapId, atomId, fromVersion, toVersion }) {
...
function buildMemberUpgradeMapping({ members, atomId, fromVersion, toVersion }) {
...
function resolveMapGeneratorProvenance(repositoryRoot, mapId, mapSpec) {
...
function inferProvenanceFromSpec(mapSpec) {
...
function parseJsonFile(absolutePath, relativePath) {
  try {
