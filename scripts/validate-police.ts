...
import { validateDependencyGraph } from '../packages/core/src/police/dependency-graph.ts';
import { validateForbiddenImports } from '../packages/core/src/police/forbidden-import-scanner.ts';
import { validateLayerBoundary } from '../packages/core/src/police/layer-boundary.ts';
import { validateRegistryConsistency } from '../packages/core/src/police/registry-consistency.ts';
import { createSchemaValidator, validateJsonDocument } from '../packages/core/src/police/schema-validator.ts';
...
const protectedFiles = [
  ...
  'packages/core/src/police/schema-validator.ts',
  'packages/core/src/police/dependency-graph.ts',
  'packages/core/src/police/layer-boundary.ts',
  'packages/core/src/police/forbidden-import-scanner.ts',
  'packages/core/src/police/registry-consistency.ts',
