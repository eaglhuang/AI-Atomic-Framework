...
import { createRegistryIndex, RegistryIndexError, semanticFingerprintPrefix } from '../packages/core/src/registry/registry-index.ts';
import { formatAtmUrn, normalizeAtmNodeRef, parseAtmUrn } from '../packages/core/src/registry/urn.ts';
...
function expectThrows(callback: any, code: any, message: any) {
  try {
    callback();
  } catch (error: any) {
