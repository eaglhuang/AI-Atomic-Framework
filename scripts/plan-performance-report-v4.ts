...
// The command/gate latency score types and pure functions now live in
// packages/core/src/telemetry/command-gate-latency-score.ts (module-boundaries:
// a package runtime must not import from scripts/; this script re-exports so
// existing callers here are unaffected).
export * from '../packages/core/src/telemetry/command-gate-latency-score.ts';
