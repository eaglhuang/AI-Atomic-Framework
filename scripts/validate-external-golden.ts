...
function copyReleaseBundleIntoHost(sourceRoot: any, targetRoot: any) {
...
assert(
  existsSync(path.join(fixtureRoot, 'src', 'index.ts')) || existsSync(path.join(fixtureRoot, 'src', 'index.mjs')),
  'external golden fixture must provide source file'
);
