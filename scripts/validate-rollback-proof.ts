...
const rolledEntry = rollbackResult.updatedRegistryDocument.entries.find((entry: any) => entry.atomId === 'ATM-FIXTURE-0001') as any;
check(Boolean(rolledEntry), 'atom rollback should keep ATM-FIXTURE-0001 in the registry');
